...
public static void main(String ar[])
{
	...
	FileReader fileReader=new FileReader("C:/Users/yoges/OneDrive/Desktop/NucleusTeq_Assignments/exceptionhandling/Question5/"+fileName1+".txt");
	FileWriter fileWriter=new FileWriter("C:/Users/yoges/OneDrive/Desktop/NucleusTeq_Assignments/exceptionhandling/Question5/"+fileName2+".txt",true);
	int x;
